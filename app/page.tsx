...
export default function Home() {
  ...
  // Load Initial Data and Registry
  useEffect(() => {
    Promise.resolve().then(() => {
      fetchFeed();
      
      // Load registered user emails from localStorage
  ...
  useEffect(() => {
    if (searchQuery.trim() === '') {
      // Avoid fetching again if we are already showing all posts on mount,
      // but if query transitions to empty, fetch the original feed.
